...
./configure --prefix=$PWD/depends/$PLATFORM --host=$PLATFORM --enable-luxgate --without-gui --disable-shared --enable-reduce-exports --enable-upnp-default CPPFLAGS="$TARGET_ARCH_FLAGS -DMINIUPNP_STATICLIB" CFLAGS="-std=c99" LDFLAGS="-static -static-libgcc -Bstatic -lstdc++ -Wl,--stack,16777216"
