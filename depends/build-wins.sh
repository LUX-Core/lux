...
./configure --prefix=$PWD/depends/$PLATFORM --host=$PLATFORM --enable-luxgate --disable-shared --enable-reduce-exports --enable-upnp-default CPPFLAGS="$TARGET_ARCH_FLAGS -DMINIUPNP_STATICLIB" CFLAGS="-std=c99" LDFLAGS="-static -static-libgcc -Wl,-Bstatic -lstdc++"
