...
brew install autoconf automake berkeley-db4 cmake leveldb libtool libzmq boost --c++11 --without-single --without-static miniupnpc openssl pkg-config protobuf qt5 libevent imagemagick --with-librsvg
export MAKEJOBS=-j4
