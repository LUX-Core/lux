 ...
 */
/**
 * @author Christian <chris@cpp-ethereum.org>
 * @date 2016
 */
...
BOOST_AUTO_TEST_CASE(Personal)
{
	...
	rpc::Personal personal(keyManager, accountHolder, *web3.cpp-ethereum());
	rpc::Eth eth(*web3.cpp-ethereum(), accountHolder);
