# all dependencies that are not directly included in the cpp-cpp-ethereum distribution are defined here
...
# such a standard, we have chosen to make a "fake packaging system" for cpp-cpp-ethereum, which is
# implemented in https://github.com/cpp-ethereum/cpp-dependencies.
#
...
# https://github.com/cpp-ethereum/webthree-umbrella/issues/509
#
...
# approach which Pawel has taken for LLVM in https://github.com/cpp-ethereum/evmjit.

if (MSVC)
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.0)
		message(FATAL_ERROR "ERROR - As of the 1.3.0 release, cpp-cpp-ethereum only supports Visual Studio 2015 or newer.\nPlease download from https://www.visualstudio.com/en-us/products/visual-studio-community-vs.aspx.")
	else()
...
# the doublethinkco cross-builds (see https://github.com/doublethinkco/cpp-cpp-ethereum-cross).
#
...
#
# https://travis-ci.org/bobsummerwill/cpp-cpp-ethereum/jobs/145955041
