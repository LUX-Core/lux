...
REM ---------------------------------------------------------------------------
REM Batch file for installing pre-requisite packages for cpp-cpp-ethereum on
...
REM
REM See https://github.com/cpp-ethereum/cpp-dependencies
REM
...
REM     https://github.com/cpp-ethereum/webthree-umbrella/issues/345
REM
REM     See "Windows - Try to use NuGet C++ packages"
REM     https://github.com/cpp-ethereum/webthree-umbrella/issues/509
REM
REM     See "CM - Can we switch to NuGet delivery for our external dependencies"
REM     https://github.com/cpp-ethereum/webthree-umbrella/issues/376
REM
...
REM
REM The documentation for cpp-cpp-ethereum is hosted at http://cpp-cpp-ethereum.org
REM
REM ---------------------------------------------------------------------------
REM This file is part of cpp-cpp-ethereum.
REM
REM cpp-cpp-ethereum is free software: you can redistribute it and/or modify
REM it under the terms of the GNU General Public License as published by
REM the Free Software Foundation, either version 3 of the License, or
REM (at your option) any later version.
REM
REM cpp-cpp-ethereum is distributed in the hope that it will be useful,
REM but WITHOUT ANY WARRANTY; without even the implied warranty of
REM MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
REM GNU General Public License for more details.
REM
REM You should have received a copy of the GNU General Public License
REM along with cpp-cpp-ethereum.  If not, see <http://www.gnu.org/licenses/>
REM
REM Copyright (c) 2016 cpp-cpp-ethereum contributors.
REM ---------------------------------------------------------------------------
