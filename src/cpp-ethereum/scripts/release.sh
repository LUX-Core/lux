...
#------------------------------------------------------------------------------
# Bash script implementing release flow for cpp-cpp-ethereum for Linux and macOS.
#
...
# Copy all the cpp-cpp-ethereum executables into a temporary directory prior to ZIP creation
...
# See https://github.com/cpp-ethereum/webthree-umbrella/issues/495.
...
cp libcpp-ethereum/*.$DLL_EXT              $ZIP_TEMP_DIR
...
zip -j $(pwd)/../cpp-cpp-ethereum-develop-$ZIP_SUFFIX.zip $ZIP_TEMP_DIR/*
