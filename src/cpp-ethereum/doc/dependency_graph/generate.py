...
# the modules within the cpp-cpp-ethereum project.   It is a mixture of
...
# efforts at understanding the dependencies for the cpp-cpp-ethereum-cross
# project which cross-builds cpp-cpp-ethereum, and then contributed to the
# main cpp-cpp-ethereum project.
#
# See https://github.com/doublethinkco/cpp-cpp-ethereum-cross for more
# information on the cross-builds project.
#
# The documentation for cpp-cpp-ethereum is hosted at http://cpp-cpp-ethereum.org
#
# (c) 2015-2016 cpp-cpp-ethereum contributors.
#------------------------------------------------------------------------------
            ...
            if os.path.isdir(absSubDirectoryPath):
                ...
                if os.path.exists(cmakeListsPath):
                    ...
                    if (moduleName == "libethcore"):
                        moduleName = "ethcore"
                    if (moduleName == "libcpp-ethereum"):
                        moduleName = "cpp-ethereum"
...
print '    "cpp-ethereum" -> "boost::regex"'
print '    "cpp-ethereum" -> "evm"'
print '    "cpp-ethereum" -> "evmjit" [style=dotted]'
print '    "cpp-ethereum" -> "json_spirit"'
print '    "cpp-ethereum" -> "p2p"'
print '    "ethash" -> "Cryptopp"'
print '    "ethash-cl" -> "ethash"'
print '    "ethashseal" -> "cpp-ethereum"'
