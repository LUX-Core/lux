...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"lux", "dfslistorders", &dfslistorders, true, true, false},
        {"lux", "dfslistproposals", &dfslistproposals, true, true, false},
        {"lux", "dfslocalstorage", &dfslocalstorage, true, true, false},
