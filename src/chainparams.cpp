...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("s1", "45.63.25.110"));
        vSeeds.push_back(CDNSSeedData("s2", "45.32.245.217"));
        vSeeds.push_back(CDNSSeedData("s3", "136.243.89.142"));
        vSeeds.push_back(CDNSSeedData("s4", "45.76.118.90"));
