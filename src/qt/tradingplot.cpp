                    ...
                    {"1d", "1440"}, {"1w", "10080"}}
{
    ...
    //TODO: my Qt 5.5.1 does not support this
...
void TradingPlot::updateCurrentInfo(QPoint pos)
{
    ...
    //TODO: my Ubuntu 16.04 Qt 5.5.1 does not support QDateTime::fromSecsSinceEpoch 
    //QString strDate = QDateTime::fromSecsSinceEpoch(
    //            static_cast<qint64>(currentFin.key), QTimeZone::utc()).toString(defTimeFormat);
    QString strDate = QString("1 Jan 1970 00:00");
...
{
    qDebug() <<baseLine->selectTest(event->pos(), true);
