...
{
if (ui->treeWidget->topLevelItemCount() > 49){
...
void CoinControlDialog::select_200() //select the first 200 inputs 
{
...
void CoinControlDialog::select_300() //select the first 300 inputs 
{
