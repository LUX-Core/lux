                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Luxsend Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::LuxsendMakeCollaterals));
    typeWidget->addItem(tr("Luxsend Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::LuxsendCreateDenominations));
    typeWidget->addItem(tr("Luxsend Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::LuxsendDenominate));
    typeWidget->addItem(tr("Luxsend Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::LuxsendCollateralPayment));
