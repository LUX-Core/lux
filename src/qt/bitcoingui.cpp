...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& lastBlockDate, double nVerificationProgress, bool header)
{
   modalOverlay->tipUpdate(count, lastBlockDate, nVerificationProgress);
    if(!clientModel)
        return;
