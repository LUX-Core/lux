...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -par=<n>               " + strprintf(_("Set the number of script verification threads (1 to %d, 0 = auto, <0 = leave that many cores free, default: %d)"), (int)boost::thread::hardware_concurrency(), DEFAULT_SCRIPTCHECK_THREADS) + "\n";
#ifndef WIN32
    ...
    while (!fLoaded && !fRequestShutdown) {
        ...
        do {
            try {
                ...
                storageController->LoadDataFromDB();
