...
{
    return WriteIC(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadLuxNodeConfig(std::string sAlias, CLuxNodeConfig& nodeConfig)
{
    return batch.Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseLuxNodeConfig(std::string sAlias)
{
    return EraseIC(std::make_pair(std::string("adrenaline"), sAlias));
}
