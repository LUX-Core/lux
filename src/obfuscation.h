// Copyright (c) 2014-2015 The Dash developers                  -*- c++ -*-
...
{
public:
    /// Is the inputs associated with this public key? (and there is 16120 LUX - checking if valid masternode)
...
public:
     ...
     * \param vRecv
     */
    void ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, bool &isObfuscationCommand);
