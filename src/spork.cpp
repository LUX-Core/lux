...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    if(!LuxsendSigner.VerifyMessage(pubkey, spork.vchSig, strMessage, errorMessage)){
        return false;
    }
...
bool CSporkManager::Sign(CSporkMessage& spork)
{
    ...
    if(!LuxsendSigner.SignMessage(strMessage, errorMessage, spork.vchSig, key2)) {
        LogPrintf("CMasternodePayments::Sign - Sign message failed");
        return false;
    }

    if(!LuxsendSigner.VerifyMessage(pubkey2, spork.vchSig, strMessage, errorMessage)) {
